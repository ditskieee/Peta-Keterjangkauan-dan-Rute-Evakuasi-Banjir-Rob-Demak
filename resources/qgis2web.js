...
map.getView().fit([12285650.139681, -790875.435430, 12345263.675188, -755409.920905], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Keterjangkauan dan Rute Evakuasi Tercepat Kabupaten Demak</h2>';
        return titleElement;
    })(),
